 ...
 */
public class ConsultaCondicao extends Fragment {


    public ConsultaCondicao() {
        // Required empty public constructor
    }

    public ConsultaCondicao(String id_order) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_consulta_condica, container, false);
        JSONArray array;
        ...
        try {
            array = new JSONArray(conf.getCondicaoPagamento());
        ...
        vListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(getActivity()!=null){
                    try {
                        String id_condicao = adpListaCondicaoPag.getItem(position).getString("payment_id");
                        String id_pedido   = id_order;
                        ((TelaPedido)getActivity()).confirmaCondicao(id_condicao,id_pedido);
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                }
